...
/**
 * Directly uploads a file to Cloudinary without the widget.
 * Useful for drag-and-drop or standard file inputs.
 */
export const uploadToCloudinary = async (file: File | Blob, category: string = 'general'): Promise<string> => {
    const formData = new FormData();
    formData.append('file', file);
    formData.append('upload_preset', UPLOAD_PRESET);
    formData.append('folder', `kosc-gallery/${category}`);
    formData.append('tags', `kosc-gallery,kosc-gallery-${category}`);
