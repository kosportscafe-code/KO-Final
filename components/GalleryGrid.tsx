            ...
            {items.map((item) => (
              ...
              >
                <img
                  ...
                  alt={generateAltText(item.url, `KOS Gallery entry`, item.category)}
        ...
        {selectedImage && (
          ...
          >
            ...
            <motion.img
              ...
              alt={generateAltText(selectedImage.url, `Full screen preview: ${selectedImage.category}`, selectedImage.category)}
